...
import org.desaparecidosbr.adapters.PessoasAdapter;
import org.desaparecidosbr.api.ApiListener;
import org.desaparecidosbr.api.PessoasApi;
...
public class MainActivity extends Activity implements ApiListener {
 ...
 //   private ShareActionProvider mShareActionProvider;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final ListView pessoasListView = (ListView) findViewById(R.id.pessoas_list);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.info:
                ...
                String info = getResources().getString(R.string.atencao) + "." + getString(R.string.origem_dados);
